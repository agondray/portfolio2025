export const GITHUB_URL = 'https://github.com/agondray';
export const LINKEDIN_URL = 'https://www.linkedin.com/in/jvestolas/';
export const MY_EMAIL = 'josephvictorestolas@gmail.com';
...
export const projectData = [
  {
    ...
    tech: ["Next.js", "React", "JavaScript ES6+", "TailwindCSS", "RadixUI", "dnd-kit"],
    path: '/quest-log',
  },
  {
  ...
  // 3D Model-To-Print From The Browser
];
